...
import { MECHANIC_RULES, mergeRulesWithDefaults } from "./ruleTemplates";
import { MeepleType, Products, Resources } from "./types";

export class Mechanic extends Meeple {
